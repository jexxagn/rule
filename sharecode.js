...
const shareCodes = [
  {
    zd: $.getdata("zd_shareCode1") || "pnf7xkm5prwxkc3rwnxr6njocm",
    nc: $.getdata("nc_shareCode1") || "b77581eedee6432b8f903eb5755b2513",
    mc: $.getdata("mc_shareCode1") || "MTE1NDQ5OTUwMDAwMDAwMzk4NTYzODM=",
    ddgc: $.getdata("dd_shareCode1") || "P04z54XCjVWnYaS5m9dQCipiiI",
    jxgc: $.getdata("jx_shareCode1") || "9D1lfMPhGSaqLpUs6Qlfzw==",
  },
];
$.result = [];
