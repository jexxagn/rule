  ...
  if (magicJS.isResponse) {
	...
	//听书解析2@https://t.me/ddgksf2021
      case /.*\/a\.p\?/.test(magicJS.request.url):
        try {
          body = magicJS.response.body.replace(/"type":\d*/g,'"type":2').replace(/"end":\d*/g, '"end":4811209694').replace(/"period":\d*/g, '"period":111').replace(/"bought_vip":\d*/g, '"bought_vip":1').replace(/"bought_vip_end":\d*/g, '"bought_vip_end":4811209694');          
        }catch (err) {
